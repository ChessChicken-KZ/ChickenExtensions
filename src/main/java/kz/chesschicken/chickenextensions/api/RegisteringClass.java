...
public class RegisteringClass implements ItemRegister, BlockRegister, EntityRegister {
    ...
    public static BlockBase oreRuby;
    public static BlockBase oreSaphire;
    ...
    public void registerItems()
    {
        ...
        itemRuby = new ItemBasic(itemRubyID.getIntValue()).setName("chickenextensions:itemRuby");
        itemSaphire = new ItemBasic(itemSaphireID.getIntValue()).setName("chickenextensions:itemSaphire");
    ...
    public void registerBlocks() {
        ...
        Property blockCouple1ID = blockIdsCategory.getProperty("blockCouple1ID", 131);
        Property blockSaplingCID = blockIdsCategory.getProperty("blockSaplingCID", 132);
        Property blockNetherrackMossyID = blockIdsCategory.getProperty("blockNetherrackMossyID", 133);
        Property blockLeavesCID = blockIdsCategory.getProperty("blockLeavesCID", 134);
        Property blockFlowerCID = blockIdsCategory.getProperty("blockFlowerCID", 135);
        Property oreAquamarineID = blockIdsCategory.getProperty("oreAquamarineID", 136);
        Property machineCartDiapenserID = blockIdsCategory.getProperty("machineCartDiapenserID", 137);

        Property netherStairsID = blockIdsCategory.getProperty("netherStairsID", 138);
        Property mossyCobblestoneStairsID = blockIdsCategory.getProperty("mossyCobblestoneID", 139);
        Property bricksStairsID = blockIdsCategory.getProperty("bricksStairsID", 140);
        Property soulBrickStairsID = blockIdsCategory.getProperty("soulBrickStairsID", 141);
        Property mossySoulBrickStairsID = blockIdsCategory.getProperty("mossySoulBrickStairsID", 142);
        Property netherBrickStairsID = blockIdsCategory.getProperty("netherBrickStairsID", 143);
        Property normalBrickStairsID = blockIdsCategory.getProperty("normalBrickStairsID", 144);
        Property stoneStairsID = blockIdsCategory.getProperty("stoneStairsID", 145);
        Property fenceExtendedID = blockIdsCategory.getProperty("fenceExtendedID", 146);
        Property stoneSmoothStairsID = blockIdsCategory.getProperty("stoneSmoothStairsID", 147);
        Property sandStoneStairsID = blockIdsCategory.getProperty("sandStoneStairsID", 148);
        Property extendedSlabsID = blockIdsCategory.getProperty("extendedSlabsID", 149);
        ...
        Property oreRubyID = blockIdsCategory.getProperty("oreRuby", 152);
        Property oreSaphireID = blockIdsCategory.getProperty("oreSaphire", 153);
...
Property blockChandelierID = blockIdsCategory.getProperty("blockChandelier", 160);
        ...
        oreAquamarine = new BlockOreAq(oreAquamarineID.getIntValue()).setName("chickenextensions:oreAquamarine");
        ...
        oreRuby = new BlockOreStone(oreRubyID.getIntValue()).setName("chickenextensions:oreRuby");
        oreSaphire = new BlockOreStone(oreSaphireID.getIntValue()).setName("chickenextensions:oreSaphire");
