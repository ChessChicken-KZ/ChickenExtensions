        ...
        for (boolean var28 = var25.nextInt(6) == 0; par15 < par16; ++par15)
        {
            ...
            if (var54 || var25.nextInt(4) != 0)
            {
                ...
                if (par6 >= var19 - 16.0D - var29 * 2.0D && par10 >= var21 - 16.0D - var29 * 2.0D && par6 <= var19 + 16.0D + var29 * 2.0D && par10 <= var21 + 16.0D + var29 * 2.0D)
                {
                    ...
                    int var56 = MathHelper.floor(par8 - var31) - 1;
                    int var38 = MathHelper.floor(par8 + var31) + 1;
                    int var57 = MathHelper.floor(par10 - var29) - par4 * 16 - 1;
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D)
                                {
                                    for (int var50 = var38 - 1; var50 >= var56; --var50)
                                    {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                        {
                                            ...
                                            if (var53 == BlockBase.GRASS.id)
                                            {
                                                var49 = true;
                                            }

                                            if (var53 == BlockBase.STONE.id || var53 == BlockBase.DIRT.id || var53 == BlockBase.GRASS.id)
                                            {
                                                if (var50 < 10)
                                                {
                                                    par5ArrayOfByte[var48] = (byte)BlockBase.FLOWING_LAVA.id;
                                                }
                                                else
                                                {
                                                    par5ArrayOfByte[var48] = 0;

                                                    if (var49 && par5ArrayOfByte[var48 - 1] == BlockBase.DIRT.id)
                                                    {
                                                        par5ArrayOfByte[var48 - 1] = this.level.getBiomeSource().getBiome(var42 + par3 * 16, var45 + par4 * 16).topTileId;
                                                    }
                                                }
                                            }
                                        }
